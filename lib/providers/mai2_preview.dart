...
class Mai2Preview {
  ...
  static Future<Map<String, dynamic>> UserLoginIn({
    ...
    maiHeader['User-Agent'] = "${obfuscate('GetUserPreviewApiMaimaiChn')}#$userID"; //将user-agent标设置为GetUserPreviewApiMaimaiChn的值和userid
    ...
    try {
      ...
      try {
        ...
        final message = aesDecrypt(Uint8List.fromList(decodedBytes)); //解压响应体并转换编码和解密数据
